...
- Top-level SAML payload: protocol:"SAML", spEntityId, acsUrls, assertionDuration, signOnUrl, nameIdFormat
- Attributes: update-or-skip (no hard fail on duplicates)
#>
